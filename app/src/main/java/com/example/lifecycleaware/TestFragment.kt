...
class TestFragment : Fragment() {
   lateinit var fragmentTestBinding: FragmentTestBinding
   val fragmentName = "TestFragment2"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val myLifecycleObserver = MyLifecycleObserver("TestFragment2")
        lifecycle.addObserver(myLifecycleObserver)
//        fragmentTestBinding.btnFragment.setOnClickListener {
            childFragmentManager.beginTransaction().add(R.id.childFrag,TestFragment2()).commit()
//        }
